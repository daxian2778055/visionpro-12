    ...
    public partial class FormModbusRtu : Form, IPlcOutputWriter, ICommRuntimeHost, ICommLinkContext
    {
        ...
        private async void button1_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                ...
                {
                    MsgErroeLog.WriteLog(connect.Message);
        ...
        private void cb7_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                ...
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 4), "chufa", cb7.Text);
            }
        }
        ...
        private void cb8_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                ...
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 5), "chufa", cb8.Text);
            }
        }
        ...
        private void cb4_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                ...
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 1), "chufa", cb4.Text);
            }
        }
        ...
        private void cb5_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                ...
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 2), "chufa", cb5.Text);
            }
        }
        ...
        private void cb6_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                ...
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 3), "chufa", cb6.Text);
            }
        }
        ...
        private void cb9_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                ...
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 6), "chufa", cb9.Text);
            }
        }
        ...
        private void cb10_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                ...
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 7), "chufa", cb10.Text);
            }
        }
        ...
        private void cb11_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                ...
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 8), "chufa", cb11.Text);
            }
        }
        ...
        private void cb12_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                ...
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 9), "chufa", cb12.Text);
            }
        }
        ...
        private void cb13_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                ...
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 1), "fankui", cb13.Text);
            }
        }
        ...
        private void cb14_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                ...
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 2), "fankui", cb14.Text);
            }
        }
        ...
        private void cb15_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                ...
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 3), "fankui", cb15.Text);
            }
        }
        ...
        private void cb16_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                ...
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 4), "fankui", cb16.Text);
            }
        }
        ...
        private void cb17_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                ...
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 5), "fankui", cb17.Text);
            }
        }
        ...
        private void cb18_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                ...
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 6), "fankui", cb18.Text);
            }
        }
        ...
        private void cb19_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                ...
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 7), "fankui", cb19.Text);
            }
        }
        ...
        private void cb20_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                ...
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 8), "fankui", cb20.Text);
            }
        }
        ...
        private void cb21_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                camera_dic[13][0] = cb21.Text;
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 13), "chufa", cb21.Text);
            }
        }
        ...
        private void cb22_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                camera_dic[10][0] = cb22.Text;
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 10), "chufa", cb22.Text);
            }
        }
        ...
        private void cb23_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                camera_dic[10][3] = cb23.Text;
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 10), "fankui", cb23.Text);
            }
        }
        ...
        private void cb24_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                camera_dic[11][0] = cb24.Text;
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 11), "chufa", cb24.Text);
            }
        }
        ...
        private void cb25_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                camera_dic[11][3] = cb25.Text;
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 11), "fankui", cb25.Text);
            }
        }
        ...
        private void cb26_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                camera_dic[12][0] = cb26.Text;
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 12), "chufa", cb26.Text);
            }
        }
        ...
        private void cb27_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                camera_dic[9][3] = cb27.Text;
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 9), "fankui", cb27.Text);
            }
        }
        ...
        private void cb28_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (chushihua)
            {
                camera_dic[12][3] = cb28.Text;
                wdini.WriteString(ModbusRtuIniStore.CameraSection(_linkId, 12), "fankui", cb28.Text);
            }
        }
        ...
        public async void ApplyExtraLinkRuntime(int linkId)
        {
            ...
            var rt = new ModbusRtuRuntime(link, this)
            {
                LinkId = cfg.LinkId,
                Config = cfg,
                Context = new ModbusRtuLinkContext(cfg, this)
            };
            rt.Start();
                                    ...
                                    foreach (var par in fins_dic)
                                    {
                                        ...
                                        for (int j = 0; j < int.Parse(par.Value[2]); j++)
                                        {
                                            if (par.Value[4] == "int")
                                            {
                                                ...
                                                // 读取short变量
                                                DemoUtils.ReadResultRender1(busRtuClient.ReadInt16((int.Parse(par.Value[1]) + j).ToString()), (int.Parse(par.Value[1]) + j).ToString(), out fins_temp);
                                            ...
                                            else if (par.Value[4] == "string")
                                            {
                                                xuanzhong_temp = int.Parse(par.Value[1]) - int.Parse(address_qishi.ToString()) + j;
                                                // 读取字符串
                                                DemoUtils.ReadResultRender1(busRtuClient.ReadString((int.Parse(par.Value[1]) + j).ToString(), 1), (int.Parse(par.Value[1]) + j).ToString(), out fins_temp);
                                                CommGridHelper.SetPollCell(_gridUi, fins_data, int.Parse(xuanzhong_temp.ToString()), fins_temp);
                                                shuju_temp += GetMiddleValue(fins_temp, " ", "\r");
                                            }
                                            else if (par.Value[4] == "long" && j % 2 == 0)
                                            {
                                                xuanzhong_temp = int.Parse(par.Value[1]) - int.Parse(address_qishi.ToString()) + j;
                                                // 读取字符串
                                                DemoUtils.ReadResultRender1(busRtuClient.ReadInt32((int.Parse(par.Value[1]) + j).ToString()), (int.Parse(par.Value[1]) + j).ToString(), out fins_temp);
                                                CommGridHelper.SetPollCell(_gridUi, fins_data, int.Parse(xuanzhong_temp.ToString()), fins_temp);
                                                shuju_temp += GetMiddleValue(fins_temp, " ", "\r");
                                            }
                                            else if (par.Value[4] == "float" && j % 2 == 0)
                                            {
                                                xuanzhong_temp = int.Parse(par.Value[1]) - int.Parse(address_qishi.ToString()) + j;
                                                // 读取字符串
                                                DemoUtils.ReadResultRender1(busRtuClient.ReadFloat((int.Parse(par.Value[1]) + j).ToString()), (int.Parse(par.Value[1]) + j).ToString(), out fins_temp);
                                                CommGridHelper.SetPollCell(_gridUi, fins_data, int.Parse(xuanzhong_temp.ToString()), fins_temp);
                                                shuju_temp += GetMiddleValue(fins_temp, " ", "\r");
                                            }
                                        }
        ...
        private void TryAutoReconnect()
        {
            ...
            MsgErroeLog.WriteLog("Modbus RTU 通讯异常，后台自动重连中...");
            System.Threading.Tasks.Task.Run(() =>
            {
                try
                {
                    ...
                    if (ok)
                    {
                        MsgErroeLog.WriteLog("Modbus RTU 自动重连成功");
                        SafeApplyConnectedUiState();
                    }
                }
                catch (Exception ex)
                {
                    MsgErroeLog.WriteLog("Modbus RTU 自动重连失败:" + ex.Message);
                }
                finally
                {
